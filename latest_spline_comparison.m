...
spline_index = 3;
nb_nodes = 10;
% Alle spline coefficiënten op nul behalve één voor evaluatie met de Boor.
...
% Effectieve berekenen van de waarden van de splines voor verschillende graden en indices.
for degree = 1:3
    for index =1:3
        for j = 1:length(x)
